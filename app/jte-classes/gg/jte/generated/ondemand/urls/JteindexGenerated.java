...
public final class JteindexGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,2,2,4,4,6,6,8,8,10,10,10,13,13,18,18,20,20,30,30,33,33,33,34,34,34,34,34,34,34,34,34,34,34,34,35,35,35,36,36,36,39,39,45,45,45,46,46,46,2,2,2,2};
		...
		gg.jte.generated.ondemand.layout.JtepageGenerated.render(jteOutput, jteHtmlInterceptor, new gg.jte.html.HtmlContent() {
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				for (var url : page.getUrls()) {
					...
					jteOutput.setContext("th", null);
					jteOutput.writeUserContent(url.getUrlChecks().isEmpty() ? "" : url.dateFormat(url.getUrlChecks().getLast().getCreatedAt()));
					jteOutput.writeContent("</th>\n                            <th scope=\"row\">");
					jteOutput.setContext("th", null);
